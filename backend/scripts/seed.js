...
const EMAIL = "alvathanish8@gmail.com"
const PASSWORD = "password123"
const NAME = "Thanish Alva"
...
const buildLogs = (habit, totalDays = 90) => {
    ...
    for (let i = 0; i < totalDays; i++) {
        ...
        // Lower completion probability on weekends
        ...
        // Simulate motivation dropping off
        ...
        // Force a broken streak around a certain day
        if (
            habit._brokeAt &&
            i >= habit._brokeAt - 2 &&
            i <= habit._brokeAt + 2
